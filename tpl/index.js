...
pug_html = pug_html + "&nbsp;(";
;pug_debug_line = 26;pug_debug_filename = "pug\u002Fbackground\u002Fprojects-experience.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = project.startDate.substring(project.startDate.length - 4, project.startDate.length)) ? "" : pug_interp));
;pug_debug_line = 26;pug_debug_filename = "pug\u002Fbackground\u002Fprojects-experience.pug";
